...
import { requireSemanticNativeModule } from '../embedding-service/native-runtime-bootstrap';

let databaseCtor: typeof import('better-sqlite3') | null = null;

function getDatabaseCtor(): typeof import('better-sqlite3') {
  if (!databaseCtor) {
    databaseCtor = requireSemanticNativeModule<typeof import('better-sqlite3')>('better-sqlite3');
  }
  return databaseCtor!;
}
...
export class SQLiteDB {
  ...
  private _stmtInsertChunk: BetterSqlite3.Statement | null = null;
  private _stmtUpdateChunk: BetterSqlite3.Statement | null = null;
  private _stmtGetChunksByFile: BetterSqlite3.Statement | null = null;
  private _stmtGetSeqDef: BetterSqlite3.Statement | null = null;
  private _stmtLinkSeqRef: BetterSqlite3.Statement | null = null;
  private _stmtDeleteChunksByFile: BetterSqlite3.Statement | null = null;
  private _stmtDeleteChunk: BetterSqlite3.Statement | null = null;
  private _stmtGetAllChunks: BetterSqlite3.Statement | null = null;
  private _stmtGetFileHashes: BetterSqlite3.Statement | null = null;
  private _stmtGetChunkCount: BetterSqlite3.Statement | null = null;
  private _stmtInsertFts: BetterSqlite3.Statement | null = null;
  private _stmtDeleteFts: BetterSqlite3.Statement | null = null;
  private _stmtGetIdsByFile: BetterSqlite3.Statement | null = null;
  private _stmtGetAllEmbeddings: BetterSqlite3.Statement | null = null;
   ...
   */
  getHandle(): BetterSqlite3.Database {
    return this.db;
  }
